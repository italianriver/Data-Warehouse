...
The goal of this project is to demonstrate fundamental end-to-end **data engineering** skills: SQL, Extract-Transform-Load processes, data modelling, and providing an analytics-ready data layer.
