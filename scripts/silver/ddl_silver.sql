...
Actions Performed:
- Checks if silver tables already exist and drops them if necessary.
- Creates new silver tables with defined data types and business-ready structures.
- Adds a metadata column 'dwh_create_date' to record when data was ingested from bronze to silver for improved lineage, future debugging.
...
1. Run this script to (re)create all empty silver tables with metadata tracking.
*/
